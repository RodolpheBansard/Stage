...
namespace InfinityCode.RealWorldTerrain
{
    public class RealWorldTerrainPrefs : RealWorldTerrainPrefsBase
    {
        ...
        private static string _mapboxAccessToken;
        ...
        public static string mapboxAccessToken
        {
            get
            {
                if (_mapboxAccessToken == null) _mapboxAccessToken = LoadPref("MapboxAPI", "");
        ...
        private void CreateChildNode(XmlNode node, string name, object value)
        {
            ...
            else if (value is UnityEngine.Object) CreateNode(node, name, AssetDatabase.GetAssetPath(value as UnityEngine.Object), true);
        ...
        public void LoadField(FieldInfo field, object target, XmlNode node)
        {
            ...
            {
                object v = AssetDatabase.LoadAssetAtPath(node.InnerText.Trim(), typeof(UnityEngine.Object));
        ...
        public void LoadFromXML(string filename)
        {
            ...
            foreach (XmlNode childNode in node.ChildNodes)
            {
                ...
                if (field == null)
                {
                    Debug.Log("Cannot find field: " + childNode.Name);
                    continue;
                }
